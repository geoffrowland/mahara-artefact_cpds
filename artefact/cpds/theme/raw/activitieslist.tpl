...
{foreach from=$activities.data item=activity}
        <tr class="{cycle values='r0,r1'}">
            ...
            <td class="c6 buttonscell btns2 cpdscontrols"><a href="{$WWWROOT}artefact/cpds/edit/activity.php?id={$activity->activity}" title="{str tag=edit}"><img src="{theme_url filename='images/btn_edit.png'}" alt="{str tag=edit}"></a>
